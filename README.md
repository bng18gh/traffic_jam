...
The baseline algorithm uses right of way to decide which cars move ahead and which slow down relative to their neighbors. Simply run the program to obersve the merging vehicle behavior. 
